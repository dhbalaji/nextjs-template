...
export function Button({ onClick, variant, leadingIcon, fullWidth, children }: ButtonProps) {
  ...
  return (
    <button className={className} onClick={onClick} type="button">
      {!!leadingIcon && (
        <span className="peer flex items-center justify-center">{leadingIcon}</span>
      )}
